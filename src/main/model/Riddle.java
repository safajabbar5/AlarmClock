...
// EFFECTS: constructs a riddle object
 ...
 public void listofRiddles() {
    riddles.add(new Riddle("I speak without a mouth and hear without ears.I have no body, but I come alive with wind. What am I?" , "echo"));
    riddles.add(new Riddle("You measure my life in hours and I serve you by expiring. I’m quick when I’m thin and slow when I’m fat. The wind is my enemy." , "candle"));
    riddles.add(new Riddle("I have keys, but no locks and space, and no rooms. You can enter, but you can’t go outside. What am I?", "keyboard"));
...
// EFFECTS: checks if the riddle answer matches the answer submitted by the user
 public boolean checkRiddleAnswer(String submittedAnswer) {  // this code is from the lab (is that fine?)
